                      ...
                      {formData.vaccinations.map((v, idx) => (
                        ...
                        >
                          ...
                          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                            <div>
                              <label className="text-[10px] font-bold text-gray-400 uppercase mb-0.5 block">Dose</label>
                              <input 
                                type="text" 
                                value={v.dosage} 
                                onChange={(e) => updateVaccination(idx, 'dosage', e.target.value)}
                                className="w-full bg-white border border-gray-300 hover:border-gray-400 focus:border-primary-500 focus:ring-2 focus:ring-primary-500/15 outline-none transition-all rounded-lg text-xs py-1 px-2"
                              />
                            </div>
                            <div>
                              <label className="text-[10px] font-bold text-gray-400 uppercase mb-0.5 block">Data</label>
                              <input 
                                type="date" 
                            ...
                            <div>
                              <label className="text-[10px] font-bold text-gray-400 uppercase mb-0.5 block">Reforço</label>
                              <input 
                                type="date" 
                            ...
                            <div>
                              <label className="text-[10px] font-bold text-gray-400 uppercase mb-0.5 block">Lote</label>
                              <input 
                                type="text" 
                                value={v.batch} 
